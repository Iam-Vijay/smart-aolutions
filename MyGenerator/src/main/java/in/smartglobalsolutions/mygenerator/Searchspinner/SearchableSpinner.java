...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    private List _items;
    private SearchableListDilog _searchableListDialog;
    ...
    private void init() {
        ...
        _searchableListDialog = SearchableListDilog.newInstance
                (_items);
